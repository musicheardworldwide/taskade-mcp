...
def _get_open_connections(client: Taskade | AsyncTaskade) -> int:
...
class TestTaskade:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "taskade/_legacy_response.py",
                        "taskade/_response.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = Taskade(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_base_url_setter(self) -> None:
        client = Taskade(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(TASKADE_BASE_URL="http://localhost:5000/from/env"):
            client = Taskade(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Taskade(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Taskade(
    ...
    def test_base_url_trailing_slash(self, client: Taskade) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Taskade) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Taskade) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Taskade(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Taskade(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Taskade(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/workspaces/workspaceId/projects").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Taskade, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncTaskade:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TASKADE_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTaskade(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTaskade) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTaskade) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTaskade) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTaskade(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncTaskade(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.workspaces.with_raw_response.create_project(
            workspace_id="workspaceId", content="content", content_type="text/markdown"
        )
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTaskade, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from taskade._utils import asyncify
        from taskade._base_client import get_platform
